...
const BillModal = ({ isOpen, onClose, billData }) => {
  ...
  return (
    <>
      ...
      `}</style>
      <Modal isOpen={isOpen} onClose={onClose} maxWidth="max-w-3xl" zIndex="z-50">
        <Modal.Header showClose={false} className="bg-white p-3 sm:p-4 lg:p-5 border-b shrink-0">
        ...
        <Modal.Body className="p-0 hide-scrollbar" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <div ref={billRef} className="p-3 lg:p-4 bg-white border-2 shadow-md">
            {/* Header */}
