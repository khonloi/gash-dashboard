...
const EditProductModal = ({
    ...
    const validateForm = useCallback(() => {
        ...
        // Validate images - combine existing and new images
    ...
    }, [formData, newImages, mainImageIndex, validateField]);
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        try {
            ...
            if (err.response?.data?.message) {
                ...
                // Extract actual message if wrapped in "Failed to update product: "
                if (errorMessage.includes('Failed to update product: ')) {
                    errorMessage = errorMessage.replace('Failed to update product: ', '');
                }
                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                    <form onSubmit={handleSubmit} className="space-y-5 lg:space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
                            <div>
                                <label htmlFor="edit-productName" className="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            <div>
                                <label htmlFor="edit-categoryId" className="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                {/* Upload Button and All Images Grid */}
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                    {/* Upload Button */}
                                    <label
                                        htmlFor="edit-image-files"
                                        className="flex flex-col items-center justify-center w-full aspect-square border-2 border-dashed border-gray-300 rounded-lg cursor-pointer transition-all duration-200 bg-white hover:bg-gray-50"
                                    >
                                        <svg
