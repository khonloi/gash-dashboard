        ...
        return (
            <div className="rounded-xl border p-6" style={{ borderColor: 'rgb(217 119 6)', boxShadow: '0 25px 70px rgba(168, 101, 35, 0.3), 0 15px 40px rgba(233, 163, 25, 0.25), 0 5px 15px rgba(168, 101, 35, 0.2)' }} role="status" aria-live="polite">
                <Loading
                    type="page"
                    size="medium"
                    message="Loading Revenue by Week..."
                />
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4 mb-4 lg:mb-6 pt-2 lg:pt-3 pb-2 lg:pb-3">
                <div className="flex-1 min-w-0">
                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-1 lg:mb-2 leading-tight">Revenue by Week</h1>
            ...
            {showFilter && (
                <div className="rounded-xl border p-3 sm:p-4 lg:p-6 mb-4 lg:mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
                        <div>
                            <label className="block text-xs lg:text-sm font-semibold text-gray-700 mb-2">Time Period</label>
                            <select
                                value={weeksToShow}
                            ...
                            <div className="flex flex-col items-center text-center space-y-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800 truncate">
                                        {replaceVND(weekSummary.currentWeekRevenueFormatted) || '0'}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-3 shadow-lg border hover:shadow-xl transition-all duration-300 h-24 flex flex-col justify-center">
                            <div className="flex flex-col items-center text-center space-y-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-800 truncate">
                                        {replaceVND(weekSummary.averageWeeklyRevenueFormatted) || '0'}
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="flex flex-col items-center text-center space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs font-bold text-gray-800 truncate">
                                            {replaceVND(weekSummary.bestWeek)}
                                        </p>
                                    </div>
                                </div>
                            </div>
