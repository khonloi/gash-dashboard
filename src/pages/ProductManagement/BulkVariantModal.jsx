...
const BulkVariantModal = ({
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} maxWidth="max-w-2xl" zIndex="z-50">
            <Modal.Header>Bulk Add Variants</Modal.Header>

            <Modal.Body className="flex-1 p-4 sm:p-6 lg:p-8">
                {product && (
            ...
            <Modal.Footer>
                ...
                <Button variant="primary" onClick={handleSubmit} disabled={loading} className="px-6">
                    {loading ? (
