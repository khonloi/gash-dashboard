        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4 mb-4 lg:mb-6 pt-2 lg:pt-3 pb-2 lg:pb-3">
                <div className="flex-1 min-w-0">
                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-1 lg:mb-2 leading-tight">Orders by Week</h1>
                    <p className="text-gray-600 text-sm sm:text-base lg:text-lg">Weekly order performance overview</p>
                </div>
            </div>
                ...
                <div className="p-3 sm:p-4 lg:p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div className="bg-gradient-to-br from-gray-50 via-white to-gray-100 rounded-xl p-4 lg:p-6 shadow-inner border border-gray-200">
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Weekly Orders Trend</h3>
                            <div className="h-64">
