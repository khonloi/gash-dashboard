...
export default function AccountModal({ isOpen, account, onClose, onSuccess, viewOnly = false }) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} maxWidth={internalViewOnly ? 'max-w-2xl' : 'max-w-md'} zIndex="z-50">
            <Modal.Header>
                <div className="flex items-center space-x-4">
                    ...
                    {internalViewOnly && !currentAccount.is_deleted && currentAccount.acc_status !== 'inactive' && (
                        <Button
                            onClick={() => setInternalViewOnly(false)}
                            variant="primary"
                            size="sm"
            ...
            <Modal.Body className="p-4 sm:p-6 lg:p-8">
                {internalViewOnly ? (
                    ...
                    // Edit Mode - Form
                    <form id="edit-account-form" onSubmit={handleSubmit} className="space-y-5 lg:space-y-6">
                        <div>
